...
<body>
	...
	<section class="pt-2 ">
		...
		<div class="section my-3 mx-auto  d-flex">
			<div class="section1 mx-2 my-5 px-2 py-1">
				<!--마이페이지 index-->
				<p class="fw-bold fs-4">마이페이지</p>
				<div class="fw-bold px-1 fs-6 mb-1">
					회원정보 관리
					<button id="toggleList1" class="btn fw-bold">+</button>
				</div>
				<ul id="myList1" class="list-group" style="display: none;">
					<li class="mx-4"><a href="updateMember.jsp"><small>나의
								정보 수정</small></a></li>
					<li class="mx-4"><a href="changePw.jsp"><small>비밀번호
								변경</small></a></li>
									...
									<form action="delete.m">
										<div class="row">
											...
											<div class="mb-3 col-sm-12">
												<button class="btn btn-light" type="submit" id=""
													style="width: 90%;">탈퇴</button>
											</div>
										</div>
									</form>
								</div>
				...
				<div class="fw-bold px-1 mt-3">
					나의 예약조회
					<button id="toggleList2" class="btn fw-bold">+</button>
				</div>
			...
			<div class="section2 mx-2 my-5 px-3 py-1">
				<!-- 마이페이지 content-->
				<p class="fw-bold">
					<small>홈 > 마이페이지</small>
				</p>
				...
				<table class="table text-center align-middle w-100 hidden "
					id="table">
					<!-- 나의 정보 테이블-->
					<thead>
					...
					<tbody>
						<tr>
							...
							<td class="text-start">
								<button type="button" class="btn btn-primary btn-sm mx-2">
									<a href="changePw.jsp" class="text-white text-decoration-none">비밀번호
										변경</a>
								</button>
							</td>
							<td>이메일</td>
						...
						<tr>
							<td>연락처</td>
							<td class="text-start">${MEMBER.phone_number }<!-- <button type="button" class="btn btn-primary btn-sm mx-2">휴대폰 인증/변경</button> -->
							</td>
							<td>마일리지</td>
							<td class="text-start">
								<button type="button" class="btn btn-primary btn-sm mx-2"
									data-bs-toggle="modal" data-bs-target="#staticBackdrop">마일리지
									조회</button> <!-- Modal -->
